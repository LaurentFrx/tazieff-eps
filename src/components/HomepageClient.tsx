...
const themes = [
  ...
  { href: "/methodes?objectif=volume",     labelKey: "pages.home.themeVolume",    descKey: "pages.home.themeVolumeDesc",    gradient: "from-blue-500 to-indigo-600",   icon: <IconBarbell /> },
