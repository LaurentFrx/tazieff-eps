...
export function CircuitTimer({ onBack }: CircuitTimerProps) {
  ...
  const handleStart = () => { unlockAudio(); ctx?.startTimer('circuit', preset, displayConfig); };
      ...
      <div className="relative overflow-hidden rounded-2xl px-5 pt-4 pb-3 transition-all duration-500" style={{ background: bannerGradient }}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1">
            ...
            <div>
              <div className="text-[18px] font-bold text-white">Circuit Training</div>
              <div className="text-[13px] font-semibold tracking-wider text-white/80">
                {stationLabel}{tours > 1 ? ` \u2014 Tour ${state.currentCycle} / ${tours}` : ''}
              </div>
            </div>
          </div>
