      ...
      <div className="flex gap-3 overflow-x-auto snap-x snap-mandatory pb-2 -mx-1 px-1" style={{ scrollbarWidth: 'none' }}>
        {exercises.map((exercise) => (
          <Link
            ...
            className="snap-start shrink-0 w-[200px] flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 p-3 transition-all duration-200 hover:bg-white/10"
          >
