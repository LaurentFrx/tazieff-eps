...
svg.appendChild(sv("circle",{id:"sp-circle-glow",cx:"0",cy:"0",r:"140",fill:"none",stroke:"url(#sp-cg)","stroke-width":"3","stroke-dasharray":"879.65","stroke-dashoffset":"879.65",opacity:"0.12",style:"filter:blur(5px)"}));
svg.appendChild(sv("circle",{id:"sp-circle",cx:"0",cy:"0",r:"140",fill:"none",stroke:"url(#sp-cg)","stroke-width":"0.8","stroke-dasharray":"879.65","stroke-dashoffset":"879.65",filter:"url(#sp-glow)"}));
svg.appendChild(sv("rect",{id:"sp-square",x:"-130",y:"-130",width:"260",height:"260",fill:"none",stroke:"url(#sp-sg)","stroke-width":"0.6","stroke-dasharray":"1040","stroke-dashoffset":"1040"}));
svg.appendChild(sv("line",{id:"sp-cross-h",x1:"-140",y1:"0",x2:"140",y2:"0",stroke:"rgba(255,255,255,0.03)","stroke-width":"0.5","stroke-dasharray":"4 8",opacity:"0"}));
svg.appendChild(sv("line",{id:"sp-cross-v",x1:"0",y1:"-140",x2:"0",y2:"140",stroke:"rgba(255,255,255,0.03)","stroke-width":"0.5","stroke-dasharray":"4 8",opacity:"0"}));
svg.appendChild(sv("line",{id:"sp-diag1",x1:"-130",y1:"-130",x2:"130",y2:"130",stroke:"rgba(255,255,255,0.015)","stroke-width":"0.4",opacity:"0"}));
svg.appendChild(sv("line",{id:"sp-diag2",x1:"130",y1:"-130",x2:"-130",y2:"130",stroke:"rgba(255,255,255,0.015)","stroke-width":"0.4",opacity:"0"}));
[[0,-136,0,-144],[136,0,144,0],[0,136,0,144],[-136,0,-144,0]].forEach(function(d){svg.appendChild(sv("line",{x1:""+d[0],y1:""+d[1],x2:""+d[2],y2:""+d[3],stroke:"#00E5FF","stroke-width":"0.8",opacity:"0","class":"sp-tick"}))});
...
setTimeout(function(){
$("sp-circle").style.transition="stroke-dashoffset 2s cubic-bezier(0.16,1,0.3,1)";$("sp-circle").style.strokeDashoffset="0";
$("sp-circle-glow").style.transition="stroke-dashoffset 2s cubic-bezier(0.16,1,0.3,1)";$("sp-circle-glow").style.strokeDashoffset="0";
setTimeout(function(){$("sp-square").style.transition="stroke-dashoffset 2.2s cubic-bezier(0.16,1,0.3,1)";$("sp-square").style.strokeDashoffset="0"},300);
...
$("sp-cross-h").style.transition="opacity 0.8s ease";$("sp-cross-h").style.opacity="1";
$("sp-cross-v").style.transition="opacity 0.8s ease";$("sp-cross-v").style.opacity="1";
$("sp-diag1").style.transition="opacity 0.8s ease";$("sp-diag1").style.opacity="1";
$("sp-diag2").style.transition="opacity 0.8s ease";$("sp-diag2").style.opacity="1";
},1400);
setTimeout(function(){
...
document.querySelectorAll(".sp-tick").forEach(function(t){t.style.transition="opacity 0.6s ease";t.style.opacity="0.35"});
