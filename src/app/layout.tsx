...
export default async function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <Script id="splash-init" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: `
(function(){
