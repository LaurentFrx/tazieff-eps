...
export const messages = {
  fr: {
    ...
    anatomy: {
      ...
      groupInfo: {
        dos: "Érecteurs du rachis, trapèzes, rhomboïdes, grand dorsal. Sollicités : tractions, rowing, soulevé de terre.",
        pectoraux: "Grand et petit pectoral, dentelé antérieur. Sollicités : développé couché, pompes, écartés.",
        abdominaux: "Grand droit, obliques, transverse. Sollicités : crunchs, gainage, relevés de jambes.",
        epaules: "Deltoïdes, supra/infra-épineux, grand rond. Sollicités : développé militaire, élévations latérales.",
        bras: "Biceps, brachial, triceps, brachio-radial. Sollicités : curls, extensions, dips.",
        psoas: "Psoas et iliaque. Fléchisseurs de hanche. Sollicités : relevés de jambes, course.",
        fessiers: "Grand, moyen et petit fessier. Sollicités : squat, fentes, hip thrust.",
        cuisses: "Quadriceps, ischio-jambiers, adducteurs. Sollicités : squat, presse, leg curl/extension.",
        mollets: "Gastrocnémiens et soléaire. Sollicités : extensions mollets, course, sauts.",
      },
    },
    checklist: {
      reset: "Réinitialiser",
  ...
  en: {
    ...
    anatomy: {
      ...
      groupInfo: {
        dos: "Erector spinae, trapezius, rhomboids, latissimus dorsi. Used in: pull-ups, rows, deadlifts.",
        pectoraux: "Pectoralis major & minor, serratus anterior. Used in: bench press, push-ups, flyes.",
        abdominaux: "Rectus abdominis, obliques, transverse. Used in: crunches, planks, leg raises.",
        epaules: "Deltoids, supra/infraspinatus, teres major. Used in: military press, lateral raises.",
        bras: "Biceps, brachialis, triceps, brachioradialis. Used in: curls, extensions, dips.",
        psoas: "Psoas and iliacus. Hip flexors. Used in: leg raises, running.",
        fessiers: "Gluteus maximus, medius & minimus. Used in: squats, lunges, hip thrusts.",
        cuisses: "Quadriceps, hamstrings, adductors. Used in: squats, leg press, leg curl/extension.",
        mollets: "Gastrocnemius and soleus. Used in: calf raises, running, jumping.",
      },
    },
    checklist: {
      reset: "Reset",
  ...
  es: {
    ...
    anatomy: {
      ...
      groupInfo: {
        dos: "Erectores espinales, trapecios, romboides, dorsal ancho. Usados en: dominadas, remo, peso muerto.",
        pectoraux: "Pectoral mayor y menor, serrato anterior. Usados en: press banca, flexiones, aperturas.",
        abdominaux: "Recto abdominal, oblicuos, transverso. Usados en: crunch, plancha, elevaciones de piernas.",
        epaules: "Deltoides, supra/infraespinoso, redondo mayor. Usados en: press militar, elevaciones laterales.",
        bras: "Bíceps, braquial, tríceps, braquiorradial. Usados en: curl, extensiones, fondos.",
        psoas: "Psoas e ilíaco. Flexores de cadera. Usados en: elevaciones de piernas, carrera.",
        fessiers: "Glúteo mayor, medio y menor. Usados en: sentadilla, zancadas, hip thrust.",
        cuisses: "Cuádriceps, isquiotibiales, aductores. Usados en: sentadilla, prensa, curl/extensión de pierna.",
        mollets: "Gastrocnemios y sóleo. Usados en: elevación de talones, carrera, saltos.",
      },
    },
    checklist: {
      reset: "Restablecer",
