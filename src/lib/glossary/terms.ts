...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  // ── Groupes musculaires → Anatomie (group keys d'anatomy-data.ts) ──
  { term: "Ischios-jambiers", variants: ["ischios-jambiers", "ischios", "ischio-jambiers"], href: "/apprendre/anatomie?muscles=cuisses_arriere", tooltip: "Muscles arrière de la cuisse", type: "anatomie" },
  ...
  { term: "Quadriceps", variants: ["quadriceps"], href: "/apprendre/anatomie?muscles=cuisses_avant", tooltip: "Muscles avant de la cuisse", type: "anatomie" },
  ...
  { term: "Triceps", variants: ["triceps"], href: "/apprendre/anatomie?muscles=triceps", tooltip: "Muscles arrière du bras", type: "anatomie" },
  ...
  { term: "Biceps", variants: ["biceps"], href: "/apprendre/anatomie?muscles=bras_anterieurs", tooltip: "Muscles avant du bras", type: "anatomie" },
