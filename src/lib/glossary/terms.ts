...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  { term: "Ischios-jambiers", variants: ["ischios-jambiers", "ischios", "ischio-jambiers"], href: "/apprendre/anatomie?muscles=membres-inferieurs", tooltip: "Muscles arrière de la cuisse", type: "anatomie" },
  { term: "Grand dorsal", variants: ["grand dorsal", "grands dorsaux"], href: "/apprendre/anatomie?muscles=dos", tooltip: "Large muscle du dos", type: "anatomie" },
  { term: "Quadriceps", variants: ["quadriceps"], href: "/apprendre/anatomie?muscles=membres-inferieurs", tooltip: "Muscles avant de la cuisse", type: "anatomie" },
  ...
  { term: "Deltoïdes", variants: ["deltoïdes", "deltoides", "deltoïde"], href: "/apprendre/anatomie?muscles=membres-superieurs", tooltip: "Muscles de l'épaule", type: "anatomie" },
  { term: "Trapèzes", variants: ["trapèzes", "trapeze", "trapèze"], href: "/apprendre/anatomie?muscles=dos", tooltip: "Muscles du haut du dos et du cou", type: "anatomie" },
  { term: "Fessiers", variants: ["fessiers", "fessier"], href: "/apprendre/anatomie?muscles=membres-inferieurs", tooltip: "Muscles des fesses", type: "anatomie" },
  { term: "Triceps", variants: ["triceps"], href: "/apprendre/anatomie?muscles=membres-superieurs", tooltip: "Muscles arrière du bras", type: "anatomie" },
  { term: "Mollets", variants: ["mollets", "mollet"], href: "/apprendre/anatomie?muscles=membres-inferieurs", tooltip: "Muscles arrière de la jambe", type: "anatomie" },
  { term: "Biceps", variants: ["biceps"], href: "/apprendre/anatomie?muscles=membres-superieurs", tooltip: "Muscles avant du bras", type: "anatomie" },
