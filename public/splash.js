...
var splash=h("div","position:fixed;inset:0;z-index:99999;background:#04040A;overflow:hidden",{id:"splash-screen","aria-hidden":"true"});
...
requestAnimationFrame(function(){
  ...
  setTimeout(function(){
    scan.style.transition="top 1.5s ease-in-out, opacity 0.3s ease";scan.style.opacity="1";scan.style.top="90%";
