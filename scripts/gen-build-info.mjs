...
const fileContents = `// This file is auto-generated by scripts/gen-build-info.mjs\n` +
  `export const envLabel = ${JSON.stringify(buildInfo.envLabel)};\n` +
  `export const appVersion = ${JSON.stringify(buildInfo.appVersion)};\n` +
  `export const gitShaShort = ${JSON.stringify(buildInfo.gitShaShort)};\n` +
  `export const buildTimeIso = ${JSON.stringify(buildInfo.buildTimeIso)};\n`;
