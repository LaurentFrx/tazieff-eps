...
description: "Connaître les muscles, leur localisation et les principes d'équilibre musculaire."
...
→ [Explorer la carte anatomique 3D](/apprendre/anatomie)
→ [Voir les types de contraction musculaire](/apprendre/contractions)
→ [Voir les principes sécuritaires](/apprendre/securite)
