...
### Paramètres essentiels de la puissance

- **Charge : 80% à 95% du max (1RM)**
  Travaillez avec des charges lourdes pour recruter un maximum de fibres musculaires.
- **1 à 6 répétitions**
  Peu de répétitions mais une intensité maximale.
- **4 à 6 séries**
  Un volume modéré pour permettre une récupération nerveuse suffisante.
- **Récupération : 3 à 5 minutes**
  Le système nerveux a besoin de temps pour se régénérer entre les séries lourdes.
- **Vitesse d'exécution : explosive en phase concentrique**
  Poussez ou tirez le plus vite possible, contrôlez la descente.
...
<Figure src="/media/apprendre/parametres/parametres-fig-001.webp" caption="Tableau récapitulatif des paramètres d'entraînement par objectif" />
<Figure src="/media/apprendre/parametres/parametres-fig-002.webp" caption="Exemples de séances par thème d'entraînement" />
<Figure src="/media/apprendre/parametres/parametres-fig-003.webp" caption="Organisation d'une séance type" />
